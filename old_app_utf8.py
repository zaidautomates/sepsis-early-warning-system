...
# Sepsis Early Warning System ΓÇö ICU Dashboard v3.0
# Author : Zaid Ali | Roll No. 40 | BS CS 6th Semester | AWKUM 2025ΓÇô26
...
# ΓöÇΓöÇ Page config ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
st.set_page_config(
    page_title="Sepsis EWS ΓÇö ICU Dashboard",
    page_icon="≡ƒÅÑ",
    layout="wide",
...
# CSS ΓÇö FIXED: readable text, proper contrast, no broken animations
# ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
st.markdown("""
<style>
...
/* Animations ΓÇö clean, no broken rgba strings */
@keyframes fadeIn {
...
/* ΓöÇΓöÇ Header card ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.header-card {
...
/* ΓöÇΓöÇ Stat cards ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.stat-card {
    background: #0a1e30;
    border: 1px solid #1a3a4a;
...
/* ΓöÇΓöÇ Risk cards ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.risk-card {
    border-radius: 16px;
    padding: 26px 20px;
    text-align: center;
...
/* ΓöÇΓöÇ Progress bar ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.prog-track {
    background: #0a1e30;
    border: 1px solid #1a3a4a;
    border-radius: 6px;
...
/* ΓöÇΓöÇ Section headers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.s-hdr {
    font-size: 10px;
    font-weight: 700;
    color: #00c8b4;
...
/* ΓöÇΓöÇ Score boxes ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.score-box {
    border-radius: 10px;
    padding: 14px 12px;
    text-align: center;
...
/* ΓöÇΓöÇ Vital chips ΓÇö FIXED CONTRAST ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.vital-chip {
    border-radius: 9px;
    padding: 10px 8px;
    text-align: center;
...
/* ΓöÇΓöÇ SIRS criteria ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.sirs-wrap {
    background: #07111f;
...
/* ΓöÇΓöÇ Alert strips ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.alert-strip {
    border-radius: 8px;
    padding: 9px 14px;
    font-size: 11.5px;
...
/* ΓöÇΓöÇ Recommendation cards ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.rec-card {
    background: #07111f;
...
/* ΓöÇΓöÇ Quick scores box ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.scores-box {
    background: #07111f;
    border: 1px solid #0e2a3a;
    border-radius: 10px;
...
/* ΓöÇΓöÇ Info box ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.i-box {
    background: #07111f;
    border: 1px solid #0e2a3a;
    border-radius: 9px;
...
/* ΓöÇΓöÇ Live badge ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.badge {
...
/* ΓöÇΓöÇ Step cards (default view) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.step-card {
    background: #0a1e30;
    border: 1px solid #1a3a4a;
    border-radius: 12px;
...
/* ΓöÇΓöÇ Summary alert bar ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
.summary-bar {
    border-radius: 10px;
    padding: 14px 18px;
    font-size: 13px;
...
try:
    ...
    st.error(f"Γ¥î Model load failed: {e}")
...
GROUPS = [
    ("≡ƒôè Vital Signs",      ['HR','O2Sat','Temp','Resp']),
    ("≡ƒ⌐╕ Blood Pressure",   ['SBP','DBP','MAP']),
    ("≡ƒö¼ Laboratory",       ['WBC','Creatinine','Bilirubin_total','Lactate','Glucose','Hgb','pH']),
    ("≡ƒæñ Patient Info",     ['Age','HospAdmTime','ICULOS']),
]
...
def compute_sirs(inp):
    return {
        ...
        'WBC >12 or <4 K/┬╡L':    inp.get('WBC',8) > 12 or inp.get('WBC',8) < 4,
    }


def compute_sofa(inp):
    """Simplified SOFA approximation (0ΓÇô12)."""
    s = 0
    o2 = inp.get('O2Sat', 97)
    if o2 < 90: s += 3
    elif o2 < 94: s += 2
...
def clinical_recs(risk_pct, inp, sirs_met, sofa):
    recs = []
    if risk_pct >= 60:
        recs.append(("high","ΓÜá∩╕Å IMMEDIATE ΓÇö SEP-1 PROTOCOL",
                     "Activate Sepsis Alert. Notify attending physician NOW. Start 30 mL/kg IV crystalloid within 3 hours."))
        recs.append(("high","≡ƒº½ CULTURES + LABS",
                     "Blood cultures ├ù 2 BEFORE antibiotics. STAT: CBC, BMP, LFTs, coagulation, procalcitonin."))
        recs.append(("high","≡ƒÆè ANTIBIOTICS",
                     f"Broad-spectrum IV antibiotics within 1 hour. MAP currently {inp.get('MAP',0):.0f} mmHg ΓÇö target ΓëÑ65."))
        recs.append(("info","≡ƒôè MONITORING",
                     "Continuous vitals, foley catheter for urine output. Target UO ΓëÑ0.5 mL/kg/hr. Reassess every 15 min."))
    elif risk_pct >= 30:
        recs.append(("mod","ΓÜí INCREASED VIGILANCE",
                     f"SIRS criteria met: {sirs_met}/4. Reassess every 30 minutes. Watch for clinical deterioration."))
        recs.append(("mod","≡ƒö¼ DIAGNOSTIC WORKUP",
                     "Order CBC, CMP, Lactate, Blood Cultures if febrile. Consider empiric antibiotics if source identified."))
        recs.append(("info","≡ƒÆº FLUID ASSESSMENT",
                     "Assess volume responsiveness. IV fluid challenge 500 mL NS if hypotensive or tachycardic."))
    else:
        recs.append(("low","Γ£à ROUTINE MONITORING",
                     "Continue standard ICU monitoring. Reassess every 4 hours."))
        if sofa >= 2:
            recs.append(("info","≡ƒôï SOFA NOTE",
                         f"SOFA score {sofa} ΓÇö document organ function baseline. Trend daily LFTs and creatinine."))
    return recs
...
with st.sidebar:
    ...
    <div style='text-align:center;padding:14px 0 16px'>
        <div style='font-size:38px'>≡ƒÅÑ</div>
    ...
    # ΓöÇΓöÇ Input mode ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    input_mode = st.radio(
        "Input method",
    ...
    # ΓöÇΓöÇ PRESET MODE ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    if input_mode == "Load preset scenario":
        ...
        st.success(f"Γ£à Scenario loaded ΓÇö {len(inputs)} values")

    # ΓöÇΓöÇ FILE UPLOAD MODE ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        if uploaded:
            ...
            st.success(f"Γ£à Loaded {len(vals)} values")
        else:
            for f in features:
                inputs[f] = float(DEFAULTS.get(f, 0.0))

    # ΓöÇΓöÇ MANUAL ENTRY MODE ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    else:
        for grp_name, feats in GROUPS:
            with st.expander(grp_name, expanded=(grp_name == "≡ƒôè Vital Signs")):
                for feat in feats:
    ...
    <div style='font-size:10.5px;color:#1e3548;line-height:1.9;font-family:JetBrains Mono'>
        ...
        ≡ƒƒó &lt;30% ΓÇö Low risk<br>
        ≡ƒƒí 30ΓÇô60% ΓÇö Moderate<br>
        ≡ƒö┤ &gt;60% ΓÇö High risk<br><br>
...
if predict_btn:
    ...
    with st.spinner("≡ƒö¼ Analyzing patient vitals..."):
        time.sleep(0.4)
    ...
    # Risk tier
    if risk_pct >= 60:
        css, icon, level = "risk-high", "≡ƒö┤", "HIGH RISK"
        msg      = "Sepsis predicted within 6 hours ΓÇö Immediate clinical review required"
        bar_clr  = "#dc2626"
        bar_grad = "linear-gradient(90deg, #7f1d1d, #dc2626)"
        alert_c  = "a-high"
        sum_bg   = "#2a0404"; sum_brd = "#8a1a1a"; sum_clr = "#fca5a5"
    elif risk_pct >= 30:
        css, icon, level = "risk-mod", "≡ƒƒí", "MODERATE RISK"
        msg      = "Elevated sepsis risk ΓÇö Monitor closely, reassess every 30 minutes"
        bar_clr  = "#d97706"
        bar_grad = "linear-gradient(90deg, #78350f, #d97706)"
        alert_c  = "a-mod"
        sum_bg   = "#2a1500"; sum_brd = "#7a4800"; sum_clr = "#fde68a"
    else:
        css, icon, level = "risk-low", "≡ƒƒó", "LOW RISK"
        msg      = "No immediate sepsis threat ΓÇö Continue standard monitoring"
        bar_clr  = "#059669"
    ...
    # ΓöÇΓöÇ ROW 1: Risk score (left) + SHAP bar (right) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    col_l, col_r = st.columns([1, 1.08], gap="large")

    with col_l:
        # Risk card ΓÇö NO circle/ring
        ...
        <div class="prog-labels">
            <span>0%</span><span>Γùé30%</span><span>Γùé60%</span><span>100%</span>
        </div>""", unsafe_allow_html=True)

        st.markdown("<div style='height:14px'></div>", unsafe_allow_html=True)

        # ΓöÇΓöÇ Clinical severity scores ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        # ΓöÇΓöÇ SIRS breakdown ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        ...
        # ΓöÇΓöÇ Recommendations ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    with col_r:
        # ΓöÇΓöÇ SHAP top-12 horizontal bar ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
        st.markdown('<p class="s-hdr">SHAP Explanation ΓÇö Feature Impact</p>', unsafe_allow_html=True)
        ...
        # Value labels on bars ΓÇö readable white text
        ...
        ax1.set_title('Feature contributions ΓÇö current patient', color=TEXT_C,
                      fontsize=9.5, fontweight='600', pad=10)
        ax1.grid(axis='x', color=GRID_C, linewidth=0.5)

        red_p   = mpatches.Patch(color=(0.96, 0.37, 0.37), label='Γåæ Increases risk')
        green_p = mpatches.Patch(color=(0.22, 0.83, 0.56), label='Γåô Decreases risk')
        ...
        direction = "Γåæ increasing" if top_val > 0 else "Γåô decreasing"
        ...
        <div class="i-box" style="margin-top:8px">
            ...
            <span style='color:#6a9aaa'>)</span> ΓÇö
            strongest factor <b style='color:{dir_clr}'>{direction}</b> risk.<br><br>
            <span style='color:#3a6070'>≡ƒö┤ Red bar = pushes risk higher &nbsp;┬╖&nbsp;
            ≡ƒƒó Green bar = pulls risk lower</span>
        </div>""", unsafe_allow_html=True)

        # ΓöÇΓöÇ Model probability bar ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ ROW 2: Vitals grid (left) + Radar + Quick Scores (right) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    st.markdown("<div style='height:16px'></div>", unsafe_allow_html=True)
    v1, v2 = st.columns([1.7, 1], gap="large")

    with v1:
        st.markdown('<p class="s-hdr">Current Vitals ΓÇö Status Overview</p>', unsafe_allow_html=True)
            ...
            for col_v, feat in zip(cols_v, row_feats):
                ...
                with col_v:
                    ...
                    <div class="vital-chip {chip}">
                        ...
                        <p class="vital-range">{mn}ΓÇô{mx}</p>
                    </div>""", unsafe_allow_html=True)
        ...
        if crit_v:
            st.markdown(f'<div class="alert-strip a-high">ΓÜá∩╕Å CRITICAL ΓÇö {", ".join(crit_v)}</div>',
                        unsafe_allow_html=True)
        if abno_v:
            st.markdown(f'<div class="alert-strip a-mod">ΓÜí ABNORMAL ΓÇö {", ".join(abno_v)}</div>',
                        unsafe_allow_html=True)
        if not crit_v and not abno_v:
            st.markdown('<div class="alert-strip a-low">Γ£à All displayed vitals within normal range</div>',
                        unsafe_allow_html=True)

        lact_val = inputs.get('Lactate', 1.5)
        if lact_val > 4:
            lact_msg = "Severe hyperlactatemia ΓÇö tissue shock likely"
            lact_cls = "a-high"
        elif lact_val > 2:
            lact_msg = "Elevated ΓÇö possible tissue hypoperfusion"
            lact_cls = "a-mod"
        else:
            lact_msg = "Within acceptable range"
            lact_cls = "a-low"
        st.markdown(f'<div class="alert-strip {lact_cls}">≡ƒº¼ LACTATE {lact_val:.1f} mmol/L ΓÇö {lact_msg}</div>',
                    unsafe_allow_html=True)

    with v2:
        # ΓöÇΓöÇ Radar chart ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ All-features SHAP bar ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    st.markdown("<div style='height:16px'></div>", unsafe_allow_html=True)
    st.markdown('<p class="s-hdr">All Feature Contributions ΓÇö Extended View (All 17 Features)</p>',
                unsafe_allow_html=True)
    ...
    ax4.set_title('SHAP Values ΓÇö All 17 Features (current patient)', color=TEXT_C,
    ...
    # ΓöÇΓöÇ Final summary bar ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    st.markdown(f"""
    <div class="summary-bar" style="background:{sum_bg};border:1px solid {sum_brd};color:{sum_clr}">
        {icon} {level} ΓÇö {risk_pct}% probability of sepsis within 6 hours &nbsp;|&nbsp;
...
# ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
    ...
    with d1:
        ...
        <div class="i-box" style="text-align:center;padding:34px 22px">
            <div style="font-size:42px;margin-bottom:10px">≡ƒæê</div>
    ...
    with d2:
        st.markdown("""
        <div class="i-box" style="text-align:center;padding:34px 22px">
            <div style="font-size:42px;margin-bottom:10px">≡ƒÆí</div>
    ...
    for col, (n, t, d) in zip([sc1, sc2, sc3, sc4], [
        ("1", "Input Vitals",      "Enter 17 ICU measurements ΓÇö vitals, labs, and patient history"),
        ...
        ("4", "SHAP Explains",     "Bar chart shows which vital drove the prediction ΓÇö transparent AI"),
    ]):
        with col:
            st.markdown(f"""
            <div class="step-card">
    ...
    ref_df = pd.DataFrame({
        'Feature':        ['Heart Rate', 'OΓéé Sat', 'Temperature', 'Lactate',
                           'WBC', 'Creatinine', 'Blood pH', 'Resp Rate', 'MAP'],
        'Normal Range':   ['60ΓÇô100 bpm', '95ΓÇô100%', '36.1ΓÇô37.2 ┬░C', '0.5ΓÇô2.0 mmol/L',
                           '4.5ΓÇô11.0 K/┬╡L', '0.7ΓÇô1.2 mg/dL', '7.35ΓÇô7.45', '12ΓÇô20 /min', '70ΓÇô105 mmHg'],
        'Sepsis Signal':  ['>90 or <60', '<94%', '>38.3┬░C or <36┬░C', '>2.0 mmol/L',
                           '>12 or <4 K/┬╡L', '>1.5 mg/dL', '<7.35', '>22 /min', '<65 mmHg'],
